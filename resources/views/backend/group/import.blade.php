            ...
            <div class="panel panel-default card-view">
                ...
                <div class="panel-wrapper collapse in">
                    <div class="panel-body">
                        <p>1. Unduh Template excel disini. <a href="{{url('group/import-download-template')}}" class="text-info"><i class="fa fa-download"></i> Unduh template</a></p>
        ...
        {{-- <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12"> --}}
            <div class="panel panel-default card-view">
                ...
                <div class="panel-wrapper collapse in">
                    <div class="panel-body">
                        <div class="form-wrap">
                            <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="{{url('group/import')}}">
                                {{ csrf_field() }}
            ...
            <div class="panel panel-default card-view">
                <div class="panel-heading">
                    ...
                    <div class="pull-right">
                        <a class="btn btn-sm btn-default " href="{{url('group/import-store-model')}}">Save to Database</a>
                    </div>
                    <div class="clearfix"></div>
                </div>
                <div class="panel-wrapper collapse in">
